...
******************************************************************************/
#ifndef LCD_PANEL_LVDS_CLK_H
#define LCD_PANEL_LVDS_CLK_H
...
/* Lvds clock setting
    ...
    /*  Note LVDS Clock
        ...
        4       4        64     1       8       33.333 MHz, WVGA Signal  800 x 480 (60 Hz)
...
/* NFD  */
#define LVDS_PLL_NFD              (64u)

/* NRD */
#define LVDS_PLL_NRD              (1u-1u)
