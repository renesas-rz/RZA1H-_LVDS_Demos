...
#define     LCD_CH0_TCON_PIN_VSYNC  VDC5_LCD_TCON_PIN_0      /** Select TCON of a Vsync signal (Vsync_TCON_select)           */
#define     LCD_CH0_TCON_PIN_HSYNC  VDC5_LCD_TCON_PIN_2      /** Select TCON of a Hsync signal (Hsync_TCON_select)           */
#define     LCD_CH0_TCON_PIN_DE     VDC5_LCD_TCON_PIN_3      /** Select TCON of a DE signal    (DE_TCON_select)              */
