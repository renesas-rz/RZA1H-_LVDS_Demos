...
#define CAMERA_OV5642    (0)
#define CAMERA_SELECT    (CAMERA_OV5642)

#if ( CAMERA_SELECT == CAMERA_OV5642 )
#include "r_camera_ov5642.h"
#define CAMERA_I2C_ADDR    (OV5642_I2C_ADDR)
#else
#error ERROR: Invalid INPUT_SELECT.
#endif
...
/* Select Imput Image Size from Camera */
#define CAMERA_RES_IMAGE_SIZE     (CAMERA_RES_VGA)
