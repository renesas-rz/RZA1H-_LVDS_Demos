...
#endif
    {
    os_task_t *p_graphics_task;
    p_graphics_task = NULL;
    p_graphics_task = R_OS_CreateTask("Graphics", (os_task_code_t)sdk_camera_graphics_sample_task, NULL, R_OS_ABSTRACTION_PRV_LARGE_STACK_SIZE, TASK_GRAPHICS_TASK_PRI );
    }
